...
// Shared read path for the PHI Log (trading journal), used by both
// api/journal.js (the dashboard's own GET) and active-positions.js (SPIRA's
// exit-signal tracking) — one source of truth for what "open" means.
